...
8. Use [.notebook/00_references/performance-checklist.md](../../.notebook/00_references/performance-checklist.md) as the minimum baseline for each area.
9. Delegate granular optimization guidance to [.cursor/skills/performance-optimization/SKILL.md](../skills/performance-optimization/SKILL.md) — keep this report at the audit level.
...
- **Invoke via:** `/webperf`. Not included in `/ship` fan-out — performance audits apply to web applications only.
- **Do not invoke from another persona.** See [.cursor/agents/README.md](./README.md) and [.notebook/00_references/orchestration-patterns.md](../../.notebook/00_references/orchestration-patterns.md).
