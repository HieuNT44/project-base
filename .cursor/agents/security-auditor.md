...
- **Do not invoke from another persona.** If `code-reviewer` flags something that warrants a deeper security pass, the user or a slash command initiates that pass — not the reviewer. See [.cursor/agents/README.md](./README.md) and [.notebook/00_references/orchestration-patterns.md](../../.notebook/00_references/orchestration-patterns.md).
